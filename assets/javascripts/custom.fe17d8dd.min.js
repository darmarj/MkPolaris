...
(() => {
  ...
  var Jr = (e, r, t) =>
    ...
    Ke = (e, r) => {
      ...
      if (Kr) for (var t of Kr(r)) yo.call(r, t) && Jr(e, t, r[t]);
      return e;
    };
  var Te = (e, r) => () => (
  ...
  var qe = Te((X) => {
    (function () {
      ...
      (R = 150),
        ...
        (E = 150),
        (u = 0.75),
        (X.score = function (h, b, S) {
          var T, y, g, _;
          return (
            (y = S.preparedQuery),
            (T = S.allowErrors),
            T || n(h, y.core_lw, y.core_up)
        ...
        (X.scoreConsecutives = l =
          function (h, b, S, T, y, g, _) {
            ...
            for (
              ...
              S[g] === h[y] && j++;
            return (
              V < k && y--, V === 1 ? 1 + 2 * j : m(V, H, j, _, f(y, h, b, U))
            );
          }),
        (X.scoreExactMatch = d =
          function (h, b, S, T, y, g, _) {
            ...
            for (
              ...
              S[y + U] === h[U] && H++;
            return (k = f(y + g - 1, h, b, _)), v(g, _, m(g, g, H, I, k), y);
          }),
        (e = (function () {
          function h(b, S, T) {
        ...
        (X.scoreAcronyms = c =
          function (h, b, S, T) {
            var y, g, _, k, U, M, H, I, j, V, re;
            if (((U = h.length), (M = S.length), !(U > 1 && M > 1))) return t;
            for (y = 0, V = 0, re = 0, I = 0, _ = -1, k = -1; ++k < M; ) {
              if (((H = T[k]), i(H)))
    ...
    (function () {
      ...
      (a = qe()),
        ...
        (n = function (c, p, l, v, d) {
          ...
          return x === 0 && d > 0 ? 0.9 * n(c, p, l, E - 2, d - 1) : x / m;
        });
    }).call(De);
  });
  var qr = Te((Xt, Bt) => {
      ...
      (a = qe()),
            ...
            return (
              ...
              v || t(c, w.core_lw, w.core_up)
                ? ((E = c.toLowerCase()),
                  (m = r(c, E, w)),
                  m.length === 0 ||
                    (c.indexOf(x) > -1 && ((d = e(c, E, w, x)), (m = i(m, d)))),
                  m)
                : []
            );
          }),
        ...
        (r = function (c, p, l, v) {
          ...
          for (
            ...
            (q[g] = 0), (S[g] = 0);
          for (y = -1; ++y < _; )
            for (V = 0, ae = 0, b = 0, de = p[y], g = -1; ++g < M; )
              (T = 0),
                (R = 0),
                (re = ae),
                j[g] === de &&
                  ((te = o(y, c, p)),
                  (T = b > 0 ? b : u(c, p, I, j, y, g, te)),
                  (R = re + s(y, g, te, E, T))),
                (ae = q[g]),
                (b = S[g]),
                V > ae ? (U = m) : ((V = ae), (U = w)),
...
` +
  ...
  var _e = {
    setTimeout: function (e, r) {
      ...
      return n != null && n.setTimeout
        ? n.setTimeout.apply(n, z([e, r], W(t)))
  ...
  var Ue = (function (e) {
    ...
    function r(t) {
      ...
      return (
        (o.isStopped = !1),
        t ? ((o.destination = t), Xe(t) && t.add(o)) : (o.destination = Oo),
        o
      );
    }
    return (
  ...
  var Oo = { closed: !0, next: ce, error: Eo, complete: ce };
  var Ie = (function () {
      ...
      (r.prototype.next = function (t) {
        ...
        Ae(function () {
          ...
          if ((o._throwIfClosed(), !o.isStopped)) {
            ...
            try {
              for (
                var f = Y(o.currentObservers), s = f.next();
                !s.done;
                s = f.next()
              ) {
                var u = s.value;
    ...
    return (
      ...
      (r.prototype._trimBuffer = function () {
        ...
        if ((o < 1 / 0 && s < i.length && i.splice(0, i.length - s), !f)) {
          for (var u = n.now(), a = 0, c = 1; c < i.length && i[c] <= u; c += 2)
            a = c;
          a && i.splice(0, a + 1);
        }
      }),
  ...
  var Ve = {
    setInterval: function (e, r) {
      ...
      return n != null && n.setInterval
        ? n.setInterval.apply(n, z([e, r], W(t)))
    ...
    return (
      (r.prototype.schedule = function (t, o) {
        ...
        var i = this.id,
          f = this.scheduler;
        return (
          i != null && (this.id = this.recycleAsyncId(f, i, o)),
          (this.pending = !0),
          (this.delay = o),
          (this.id =
            (n = this.id) !== null && n !== void 0
              ? n
              : this.requestAsyncId(f, this.id, o)),
          this
        );
      }),
      ...
      (r.prototype.requestAsyncId = function (t, o, n) {
        return (
          ...
          n !== null && n > 0
            ...
            : (t.actions.push(this),
              t._scheduled ||
                (t._scheduled = Ce.requestAnimationFrame(function () {
      ...
      (r.prototype.recycleAsyncId = function (t, o, n) {
        ...
        o != null &&
          ((i = f[f.length - 1]) === null || i === void 0 ? void 0 : i.id) !==
            o &&
          (Ce.cancelAnimationFrame(o), (t._scheduled = void 0));
      }),
      r
    );
  })(er);
  ...
  function Et(e) {
    if (e.length === 1) {
      var r = e[0];
      if (Uo(r)) return { args: r, keys: null };
      if (jo(r)) {
        var t = $o(r);
        return {
    ...
    return (
      ...
      new C(function (n) {
        ...
        return t.schedule(function () {
          n.closed ||
            (n.next(f++), 0 <= o ? this.schedule(void 0, o) : n.complete());
        }, i);
      })
    );
  }
  function N() {
    ...
    var t = ne(e),
      o = dt(e, 1 / 0),
      n = e;
    return n.length ? (n.length === 1 ? F(n[0]) : hr(o)(se(n, t))) : Me;
  }
  var je = new C(ce);
                  ...
                  L(
                    ...
                    function (c) {
                      if (
                        ...
                        n.next(t ? t.apply(void 0, z([], W(p))) : p),
                          i.some(function (l, v) {
                            return !l.length && f[v];
                          }) && n.complete();
                      }
    ...
    return A(function (r, t) {
      ...
      r.subscribe(
        L(
          t,
          function (a) {
            (o = !0), (n = a), i || F(e(a)).subscribe((i = L(t, s, u)));
          },
          function () {
  ...
  function Ur(e, r) {
    return r
      ? function (t) {
          return $e(r.pipe(Fe(1), Pt()), t.pipe(Ur(e)));
        }
      : we(function (t, o) {
          return F(e(t, o)).pipe(Fe(1), Rt(t));
        });
  }
  function zr(e, r) {
    r === void 0 && (r = ge);
  ...
  function Vr(e, r) {
    ...
    if (r !== !1) {
      ...
      return F(r.apply(void 0, z([], W(t)))).subscribe(n);
    }
  }
  function me(e, r, t) {
    var o,
      ...
      ? A(function (n, i) {
          ...
          n.subscribe(
            L(
              ...
              function (u) {
                var a;
                (a = o.next) === null || a === void 0 || a.call(o, u),
                  i.next(u);
              },
              function () {
                var u;
              ...
              function (u) {
                var a;
                (s = !1),
                  (a = o.error) === null || a === void 0 || a.call(o, u),
                  i.error(u);
              },
              function () {
                var u, a;
                s &&
                  ((u = o.unsubscribe) === null || u === void 0 || u.call(o)),
  ...
  var Bo = N(D(document.body, "focusin"), D(document.body, "focusout")).pipe(
    Wr(1),
    he(void 0),
    P(() => jr() || document.body),
    me(1)
  ...
  function Vt(e) {
    return N(D(e, "scroll"), D(window, "resize")).pipe(
      kr(0, Pr),
      P(() => zt(e)),
      he(zt(e))
    );
  ...
  function $t(e, r) {
    ...
    else if (Array.isArray(r)) for (let t of r) $t(e, t);
  }
  function J(e, r, ...t) {
    ...
    return Se(
      () => (
        ...
        N(
          D(r, "load"),
          D(r, "error").pipe(
            Q(() => Fr(() => new ReferenceError(`Invalid script: ${e}`)))
          )
        ).pipe(
          P(() => {}),
  ...
  var Zo = new B(),
    Ep = Se(() =>
      typeof ResizeObserver == "undefined"
        ? Nt("https://unpkg.com/resize-observer-polyfill")
        : ie(void 0)
    ).pipe(
      P(
        () =>
        ...
        typeof (r == null ? void 0 : r.progress$) != "undefined" &&
          (o.addEventListener("progress", (n) => {
            if (n.lengthComputable)
              ...
              let i = Number(o.getResponseHeader("Content-Length")) || 0;
              r.progress$.next((n.loaded / i) * 100);
            }
          }),
          r.progress$.next(5)),
        o.send();
  ...
  function Gt(e) {
    ...
    return (
      ...
      Re([t, r]).pipe(P(([o, n]) => ({ ref: e, value: o, focus: n })))
    );
  }
  var Qr = Gr(Dr());
  var ao = Gr(Dr());
    ...
    switch (e.getAttribute("data-mdx-mode")) {
      case "file":
        return Re([
          ...
          r.pipe(
            P(({ icons: o }) =>
              Object.values(o.data).map((n) => n.replace(/\.svg$/, ""))
            )
          ),
        ]).pipe(
          P(([{ value: o }, n]) => (0, Qr.filter)(n, o)),
          Q((o) =>
            r.pipe(
              P(({ icons: n }) => ({
                data: o.map((i) => ({
  ...
  function so(e, { index$: r, query$: t }) {
    let o = new B(),
      n = Qt(e).pipe(Ee(Boolean)),
      i = Z(":scope > :first-child", e);
    o.pipe(He(t)).subscribe(([{ data: u }, { value: a }]) => {
      if (a)
        switch (u.length) {
          case 0:
    ...
    return (
      o
        ...
        .subscribe(([u, { value: a }]) => s.appendChild(fo(u, a, f))),
      on(e, { query$: t, index$: r }).pipe(
        ke((u) => o.next(u)),
        le(() => o.complete()),
        P((u) => Ke({ ref: e }, u))
      )
  ...
  function lo(e) {
    ...
    return (
      r.subscribe((n) => {
        ...
        for (let f of n.sponsors)
          f.type === "public" && i.appendChild(uo(f.user));
        i.appendChild(
          co(n.sponsors.filter(({ type: f }) => f === "private").length)
        ),
          (t.innerText = `${n.sponsors.length}`),
          (o.innerText = `$ ${n.total
            .toString()
            .replace(/\B(?=(\d{3})+(?!\d))/g, ",")} a month`);
      }),
      r.pipe(P((n) => Ke({ ref: e }, n)))
    );
  }
  function mo() {
  ...
  mo();
  var nn = document$.pipe(
    Q(() =>
      N(
        ...Nr("iconsearch").map((e) => po(e)),
        ...Nr("sponsorship").map((e) => lo(e))
      )
    )
  );
  nn.subscribe();
